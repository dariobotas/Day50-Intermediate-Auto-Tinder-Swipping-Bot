...
# Tinder free tier only allow 100 "likes" per day. If you have a premium account, fell free to change to a while loop.
for n in range(100):
    ...
    try:
        ...
        try:
            match_popup = driver.find_element(By.CSS_SELECTOR,".itsAMtach a")
            match_popup.click()
